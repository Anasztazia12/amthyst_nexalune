const translations = {
    en: {
        ...
        home_stat1_p: 'Clean, modern websites that look good and work well on every screen. Perfect for landing pages, portfolios, small business sites, or personal projects.',
        home_stat1_p2: 'I can also help with content strategy, layout, and visual design to make sure the site is clear, readable, and easy to navigate.',
        home_stat2: 'Web Applications',
        home_stat2_p: 'Web applications that keep complex tasks simple and easy to read. Perfect for dashboards, forms, and interactive tools that need to work on tablets and phones.',
        home_stat2_p2: 'Ideal for tools, trackers, dashboards, forms, or anything that needs logic and user interaction.',
        home_stat3: 'Branding & UX/UI Design',
        home_stat3_p: 'Clear visual style, wireframes, and structure for a consistent, easy-to-use product.',
        home_stat3_p2: 'Includes color palette, typography, layout planning, and user-friendly page flow.',
        ...
        services_web_alap_point1: 'Landing page or small 1–3 page site',
        services_web_alap_point2: 'Responsive layout for phone, tablet, and desktop',
        services_web_alap_point3: 'Contact form connected to your inbox',
        services_web_alap_point4: 'Clean, fast-loading structure',
        ...
        services_web_ultra_point1: 'Up to 7 pages — Home, About, Services, Portfolio, Contact, and more',
        services_web_ultra_point2: 'Custom visual design system',
        services_web_ultra_point3: 'Bilingual content support (EN/HU)',
        services_web_ultra_point4: 'Blog, portfolio grid, or case study layout',
        ...
        services_web_premium_point1: '8+ pages, expandable as the project grows',
        services_web_premium_point2: 'Full UX research and design consulting',
        services_web_premium_point3: 'CMS-ready structure for easy content updates',
        services_web_premium_point4: 'Advanced interactions, animations, and priority support',
    ...
    hu: {
        ...
        home_stat1_p: 'Letisztult, modern weboldalak, amelyek minden képernyőn jól néznek ki és jól működnek. Tökéletes landing oldalakhoz, portfóliókhoz, kisvállalkozói oldalakhoz vagy személyes projektekhez.',
        home_stat1_p2: 'Emellett segítek a tartalmi stratégiában, az elrendezésben és a vizuális designban is, hogy az oldal érthető, jól olvasható és könnyen navigálható legyen.',
        home_stat2: 'Webalkalmazások',
        home_stat2_p: 'Webalkalmazások, amelyek a bonyolult feladatokat is egyszerűvé és könnyen olvashatóvá teszik. Tökéletes dashboardokhoz, űrlapokhoz és interaktív eszközökhöz, amelyeknek tableten és telefonon is működniük kell.',
        home_stat2_p2: 'Ideális eszközökhöz, nyomkövetőkhöz, dashboardokhoz, űrlapokhoz, vagy bármihez, ami logikát és felhasználói interakciót igényel.',
        home_stat3: 'Arculat és UX/UI tervezés',
        home_stat3_p: 'Tiszta vizuális stílus, drótvázak és szerkezet egy konzisztens, könnyen használható termékhez.',
        home_stat3_p2: 'Tartalmazza a színpalettát, a tipográfiát, az elrendezés tervezését és a felhasználóbarát oldalfolyamot.',
        ...
        services_web_alap_point1: 'Landing oldal vagy kisebb, 1–3 oldalas weboldal',
        services_web_alap_point2: 'Reszponzív elrendezés telefonon, tableten és asztali gépen',
        services_web_alap_point3: 'Kapcsolatfelvételi űrlap, közvetlenül a postafiókodba kötve',
        services_web_alap_point4: 'Tiszta, gyorsan betöltődő szerkezet',
        ...
        services_web_ultra_point1: 'Akár 7 oldal — Főoldal, Rólunk, Szolgáltatások, Portfólió, Kapcsolat és több',
        services_web_ultra_point2: 'Egyedi vizuális design rendszer',
        services_web_ultra_point3: 'Kétnyelvű tartalom támogatás (EN/HU)',
        services_web_ultra_point4: 'Blog, portfólió rács vagy esettanulmány elrendezés',
        services_web_premium_kicker: 'Premium',
        services_web_premium_h3: 'Nagyobb oldal teljes design támogatással.',
        services_web_premium_scope: '8+ oldal',
        services_web_premium_point1: '8+ oldal, amely a projekttel együtt bővíthető',
        services_web_premium_point2: 'Teljes UX kutatás és design tanácsadás',
        services_web_premium_point3: 'CMS-re felkészített szerkezet, könnyű tartalomfrissítéshez',
        services_web_premium_point4: 'Komplex interakciók, animációk és kiemelt support',
