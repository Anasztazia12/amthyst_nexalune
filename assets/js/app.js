const translations = {
    en: {
        ...
        home_card2_h3: 'Web apps for kids, adults, and anything in between.',
        home_card2_p: 'Sports, psychology, learning, budgeting — or whatever you have in mind. A web app is a program that runs right in your browser, no install needed, and works just as well on a phone as it does on a computer. We figure out what you actually need together, then build it — logins, personal data, dashboards, whatever the project calls for.',
    ...
    hu: {
        ...
        home_card2_h3: 'Web appok — gyerekeknek, felnőtteknek, bármilyen ötlethez.',
        home_card2_p: 'Sport, pszichológia, tanulás, költségvetés-kezelés — vagy bármi más, amit elképzelsz. Egy web app egy olyan program, ami a böngésződben fut, nincs hozzá telepítés, mégis ugyanúgy működik telefonon, mint gépen. Elmondod, mire van szükséged, és együtt felépítjük — legyen az bejelentkezés, saját adatok, dashboard, vagy bármi más, amit a projekted igényel.',
